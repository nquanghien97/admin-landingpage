...
function AddFeedback(props: AddFeedbackProps) {
  ...
  return (
    <Modal
      ...
      footer={false}
    >
      <div className="w-full text-center p-3 h-[60px] leading-[36px] bg-[#0071BA] rounded-t-lg uppercase font-bold">Thêm Feedback</div>
      <div className="p-4">
